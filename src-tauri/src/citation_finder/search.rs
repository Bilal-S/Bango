...
pub struct Finalists {
    pub article_ids: Vec<String>,
    pub per_claim: Vec<ClaimWork>,
}
...
pub fn cosine_best_chunk<'a>(hit: &EmbeddingHit, chunks: &'a [Chunk]) -> Option<&'a Chunk> {
...
pub fn pool_finalists(works: Vec<ClaimWork>) -> Finalists {
