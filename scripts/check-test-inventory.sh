...
PLAN_DOCS=(docs/test-plans/language-plan-v2-tests.md docs/test-plans/translation-3-tests.md docs/test-plans/search-strategy-tests.md docs/test-plans/openalex-tests.md)
