...
| `src-tauri/src/translation/worker.rs::reenqueue_stranded_on_startup_caps_at_20` | Tier 1c: stranded count above `STARTUP_STRANDED_CAP` resets the excess to `failed` with an audit note. |
