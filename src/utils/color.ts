/** Parse hex color (#RRGGBB) into RGB components. */
...
/** Mix a hex color with white/black. @param amount - 0=same, 1=white, negative=darken */
...
/** Palette for hash-based fallback colors when no custom color is set. */
...
/** Get effective color for a tag/label, considering custom color or hash fallback. */
...
/** Linearly interpolate node color by publication year, #56B4E9 (start) → #E69F00 (end). */
