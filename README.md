...
| File | Best For |
|------|----------|
| [`Bango_3.0.6_amd64.AppImage`](https://github.com/Bilal-S/Bango/releases/download/v3.0.6/Bango_3.0.6_amd64.AppImage) | **Recommended.** Portable; no installation required. Works on any modern Linux distribution. |
| [`Bango_3.0.6_amd64.deb`](https://github.com/Bilal-S/Bango/releases/download/v3.0.6/Bango_3.0.6_amd64.deb) | Debian, Ubuntu, and derivatives. Installs via the system package manager. |
...
| File | Best For |
|------|----------|
| [`Bango_3.0.6_aarch64.dmg`](https://github.com/Bilal-S/Bango/releases/download/v3.0.6/Bango_3.0.6_aarch64.dmg) | **Recommended.** For Apple Silicon (M-CPU) Macs. Drag-and-drop install to Applications. You will be asked to grant permissions during install. |
...
1. Download [`Bango_3.0.6_x64-setup.exe`](https://github.com/Bilal-S/Bango/releases/download/v3.0.6/Bango_3.0.6_x64-setup.exe) (or the [`.msi`](https://github.com/Bilal-S/Bango/releases/download/v3.0.6/Bango_3.0.6_x64_en-US.msi) for enterprise installs).
...
1. Download [`Bango_3.0.6_aarch64.dmg`](https://github.com/Bilal-S/Bango/releases/download/v3.0.6/Bango_3.0.6_aarch64.dmg).
